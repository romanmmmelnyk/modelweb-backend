...
CREATE TABLE "website_templates" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "desktopScreenshot" TEXT NOT NULL,
    "tabletScreenshot" TEXT NOT NULL,
    "mobileScreenshot" TEXT NOT NULL,
...
INSERT INTO "new_websites" ("accentColor", "completedAt", "configJson", "createdAt", "customAbout", "customEmail", "customName", "customPhone", "enableBooking", "fullDomain", "id", "notes", "publishedAt", "reflectUserInfo", "requestedAt", "showGallery", "status", "subdomain", "updatedAt", "userId") SELECT "accentColor", "completedAt", "configJson", "createdAt", "customAbout", "customEmail", "customName", "customPhone", "enableBooking", "fullDomain", "id", "notes", "publishedAt", "reflectUserInfo", "requestedAt", "showGallery", "status", "subdomain", "updatedAt", "userId" FROM "websites";
DROP TABLE "websites";
